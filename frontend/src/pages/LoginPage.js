...
const LATTE_ART = 'https://images.unsplash.com/photo-1541167760496-1628856ab772?w=800&q=80';
      ...
      >
        ...
        <div style={{
          ...
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1rem', maxWidth: 360, margin: 0 }}>
            Every cup tells a story. Let us write yours.
          </p>
        </div>
      </div>
      ...
      >
        <div style={{ maxWidth: 420, width: '100%' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.25rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
                ...
                <Link to="/forgot-password" style={{ fontSize: 12, color: '#6F4E37', fontWeight: 500, textDecoration: 'none' }}>
                  Forgot password?
                </Link>
              </div>
              <div style={{ position: 'relative' }}>
          ...
          <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.9rem', color: '#78716c' }}>
            ...
            <Link to="/register" style={{ color: '#6F4E37', fontWeight: 600, textDecoration: 'none' }}>Register</Link>
          </p>
        </div>
